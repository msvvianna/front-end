...
-`<meta charset="UTF-9">`: Define a codificação de caracteres como UTF-8, que suporta quase todos os caracteres e símbolos.
...
## 11 - Tags comuns# 04/09/2024 - INICIO CURSO HTML E CSS - DAY 1
